...
# Cargar constantes
constants = pd.read_csv("shared/images/constantes.csv", sep=";").set_index("Type")
...
def process_image(file_path):
    ...
    dest_dir_tier1 = f"shared/tier1/{tier1_class}"
    ...
    if tier1_class == "PC":
        ...
        dest_dir_pc = f"shared/pc/{pc_class}"
    ...
    # Actualizar CSV
    vehicle_data_csv = "shared/images/vehicle_data.csv"
