...
def extract_images(video_path, output_dir, coords, tol, csv_file, target_size=224, truck_size=320):
    ...
    model_path = os.getenv("MODEL_EXTRACTION_PATH", "models/best.pt")
    ...
    while cap.isOpened():
        ...
        for box, track_id, class_id in zip(boxes, ids, class_ids):
            ...
            bbox_size = truck_size if class_id in [5, 7] else target_size
...
if __name__ == "__main__":
    ...
    coords_str = os.getenv("COORDS", "[[[13, 322], [221, 231], [853, 566], [932, 278]]]")
    ...
    report.generar_reporte_html(vehicle_data_csv, results_dir, os.path.join(results_dir, "reporte.html"))
